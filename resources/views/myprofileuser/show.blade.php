            ...
            <div class="col-md-8">
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <p class="mb-3"><strong>ที่อยู่:</strong> {{ $user->address1 }}</p>
                        <p class="mb-3"><strong>ที่อยู่:</strong> {{ $user->address2 }}</p>
                        <p class="mb-3"><strong>ที่อยู่:</strong> {{ $user->address3 }}</p>
                        <p class="mb-3"><strong>เบอร์มือถือ:</strong> {{ $user->phone_number }}</p>
                        <p class="mb-4"><strong>รหัสผ่าน:</strong> {{ str_repeat('*', min(strlen($user->password), 10)) }}
                        </p>
                        <div class="text-center">
                            <a href="{{ route('myprofileuser.edit') }}" class="btn btn-primary"
    ...
    document.getElementById('edit-button').addEventListener('click', function(event) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location.href = '{{ route('myprofileuser.edit') }}';
            }
        });
    });
</script>
