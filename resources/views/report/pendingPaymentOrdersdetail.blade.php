            ...
            <div class="card-body">
                ...
                <div class="card-body">
                    <form action="{{ route('update.order', $order->id) }}" method="POST">
                        ...
                        <a href="{{ route('report.pendingPaymentOrders') }}" class="btn btn-primary">อัพเดท</a>
                        <a href="{{ route('report.pendingPaymentOrders') }}" class="btn btn-success">กลับรายการสั่งซื้อล่าสุดที่รอดำเนินการ</a>
                    </form>
                </div>
            </div>
        </div>
