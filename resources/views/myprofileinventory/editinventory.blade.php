    ...
    <div class="d-flex align-items-center justify-content-center min-vh-100">
        <div class="w-100" style="max-width: 600px;">
            <div class="card mt-4 p-4">
                ...
                <form method="POST" action="{{ route('myprofileinventory.updateinventory') }}" id="update-form">
                    @csrf
                    @method('PUT')
                    <div class="mb-3">
                    ...
                    <div class="mt-4 text-center">
                        ...
                        <a href="{{ route('myprofileinventory.showinventory') }}" class="btn btn-success"
    ...
    <script>
        ...
        document.getElementById('back-button').addEventListener('click', function(event) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = '{{ route('myprofileinventory.showinventory') }}';
                }
            });
        });
    </script>
