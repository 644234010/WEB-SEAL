<x-app-layout>
    <div class="content-header py-3 bg-light border-bottom">
        <div class="container-fluid">
            <div class="row mb-2 align-items-center">
                <div class="col-sm-6">
                    <h1 class="m-0">Finace Dashboard</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right bg-transparent p-0 m-0">
                        <li class="breadcrumb-item"><a href="/dashboard" class="text-decoration-none">Dashboard</a></li>
                        <li class="breadcrumb-item active"><a href="/doc" class="text-decoration-none">ออกรายงาน</a></li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <div class="card mt-4">
        <div class="card-header">
            ...
            <a href="/finacereport/pendingPaymentOrders" class="float-right">ดูทั้งหมด</a>
        </div>
        <div class="card-body">
