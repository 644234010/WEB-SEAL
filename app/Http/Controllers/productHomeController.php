...
class ProductHomeController extends Controller
{
    ...
    public function products()
    {
        ...
        return view('auth.login', compact('products', 'recommendedProducts', 'categories'));
    }
    ...
    public function productsByCategory($categoryId)
    {
        ...
        return view('auth.products_by_category', compact('products', 'recommendedProducts', 'categories', 'selectedCategory'));
    }
