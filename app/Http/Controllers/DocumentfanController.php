...
class DocumentfanController extends Controller
{
    public function doc()
    {
        ...
        return view('doc', compact('orders', 'totalDocuments', 'totalAmount', 'categories', 'brandOrders'));
    }
    ...
    private function generatePDF($orders)
    {
        ...
        $html = view('reportoder', compact('orders', 'orderDetails'))->render();
        $mpdf->WriteHTML($html);
